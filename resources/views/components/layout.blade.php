    ...
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        ...
        <div class="flex-row my-3 my-md-0">
          ...
          <!-- <a href="/profile/{{auth()->user()->username}}" class="mr-2"><img title="My Profile" data-toggle="tooltip" data-placement="bottom" style="width: 32px; height: 32px; border-radius: 16px" src="/storage/public/avatar/{{auth()->user()->avatar}}"
           /></a> -->

           <!--add filter in path from user Model  -->
